...
/* Duduf Actions for After Effects
	addAdjustmentLayer : Ajouter un solide
	...
	*/
		...
		var script = "//#addAdjustmentLayer \n" + 
        "var calque = app.project.activeItem.layers.addSolid([1,1,1],\"Calque d'effets\",app.project.activeItem.width,app.project.activeItem.height,app.project.activeItem.pixelAspect);\n" +
        "calque.adjustmentLayer = true;\n" +
        "delete calque;\n\n";
