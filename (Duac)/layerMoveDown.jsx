...
/* Duduf Actions for After Effects
	layerMoveDown : Exécute un script
	...
	*/
        ...
        //le code
		var script = "//#layerMoveDown \n" +
        "for (i=0;i<app.project.activeItem.selectedLayers.length;i++) {\n" +
        "if (app.project.activeItem.selectedLayers[i].index != app.project.activeItem.layers.length) app.project.activeItem.selectedLayers[i].moveAfter(app.project.activeItem.layer(app.project.activeItem.selectedLayers[i].index+1)) ;\n" + 
        "}\n\n";
